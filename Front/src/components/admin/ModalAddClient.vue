<template>
  ...
  >
    ...
    <div class="w-100 m-0 modal-body pl-3 h-auto pb-0">
      <h2 class="client-header-custom">Новый клиент</h2>
  ...
  computed: {
    ...
    user() {
      return {
        ...
        agreement: this.newUser.agreement.split(' ')[1],
        ...
        serviceprice: this.newUser.price,
      };
    },
  },
};
