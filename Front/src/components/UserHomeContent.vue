      ...
      <b-row>
        <b-col class="left-content" cols="12" lg="6">
          <b-row style="margin: 0">
            <CardClients v-if="profile.role == 'Admin'" />

            <CardServices v-if="profile.role != 'Admin' && services.length" :services="services" class="mt-4" />
...
import CardServices from "@/components/Cards/CardServices.vue";
